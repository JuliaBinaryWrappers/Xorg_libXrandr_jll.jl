...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Xorg_libXrandr_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("ec84b674-ba8e-5d96-8ba1-2a689ba10484"))
...
if best_platform === nothing
    @debug("Unable to load Xorg_libXrandr; unsupported platform $(triplet(platform_key_abi()))")
else
